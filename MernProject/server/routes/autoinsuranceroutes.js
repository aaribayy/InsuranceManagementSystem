...
const insurances=require('../model/autoinsurance');
const express=require('express')


const router=express.Router();
// create Insurance
router.post("/createautoinsurance", async (req, res) => {
...
// get
router.get("/autoinsurance", async (req, res) => {
  try {
...
router.get('/getautoinsurance/:id',(req,res)=>{
...
router.put("/updateautoinsurance/:id", async (req, res) => {
  try {
    const { id } = req.params;
...
//delete
router.delete("/deleteautoinsurance/:id", async (req, res) => {
  try {
    const { id } = req.params;
